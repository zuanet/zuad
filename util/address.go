...
import (
	...
	"github.com/zuanet/zuad/util/bech32"
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"zua":     Bech32PrefixZua,
	"zuadev":  Bech32PrefixZuaDev,
	"zuatest": Bech32PrefixZuaTest,
	"zuasim":  Bech32PrefixZuaSim,
}
...
// and a payload which encodes the zua network and address type. It is used
