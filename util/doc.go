/*
Package util provides zua-specific convenience functions and types.

# Block Overview

A Block defines a zua block that provides easier and more efficient
...
A Tx defines a zua transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a zua address. While the
most common type is a pay-to-pubkey, zua already supports others and
...
To decode/encode an address:
	...
	addrString := "zua:qqj9fg59mptxkr9j0y53j5mwurcmda5mtza9n6v9pm9uj8h0wgk6uma5pvumr"
	defaultPrefix := util.Bech32PrefixZua
