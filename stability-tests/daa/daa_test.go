...
import (
	...
	"github.com/zuanet/zuad/infrastructure/network/rpcclient"
...
const miningAddress = "zuadev:qrcqat6l9zcjsu7swnaztqzrv0s7hu04skpaezxk43y4etj8ncwfkuhy0zmax"
...
func runDAATest(t *testing.T, testName string, runDuration time.Duration,
	...
	tearDownZuad := common.RunZuadForTesting(t, "zuad-daa-test", rpcAddress)
	defer tearDownZuad()
