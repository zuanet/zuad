...
import (
	...
	"github.com/zuanet/zuad/app/protocol/flows/ready"
	"github.com/zuanet/zuad/app/protocol/flows/v5"
	"sync"
	"sync/atomic"

	"github.com/zuanet/zuad/app/appmessage"
	"github.com/zuanet/zuad/app/protocol/flows/handshake"
	peerpkg "github.com/zuanet/zuad/app/protocol/peer"
	"github.com/zuanet/zuad/app/protocol/protocolerrors"
	...
	routerpkg "github.com/zuanet/zuad/infrastructure/network/netadapter/router"
...
func (m *Manager) routerInitializer(router *routerpkg.Router, netConnection *netadapter.NetConnection) {
	...
	// errChan is used by the flow zuaoutines to return to runFlows when an error occurs.
