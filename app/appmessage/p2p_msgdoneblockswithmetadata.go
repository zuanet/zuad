...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a zua
...
// NewMsgDoneBlocksWithTrustedData returns a new zua DoneBlocksWithTrustedData message that conforms to the
// Message interface.
