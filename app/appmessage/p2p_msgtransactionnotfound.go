...
// MsgTransactionNotFound defines a zua TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new zua transactionsnotfound message that conforms to the
