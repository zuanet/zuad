...
// MsgRequestAnticone implements the Message interface and represents a zua
...
// NewMsgRequestAnticone returns a new zua RequestPastDiff message that conforms to the
