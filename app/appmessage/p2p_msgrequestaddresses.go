...
// MsgRequestAddresses implements the Message interface and represents a zua
...
// NewMsgRequestAddresses returns a new zua RequestAddresses message that conforms to the
