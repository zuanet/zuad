...
// MsgRequestNextHeaders implements the Message interface and represents a zua
...
// NewMsgRequestNextHeaders returns a new zua RequestNextHeaders message that conforms to the
// Message interface.
