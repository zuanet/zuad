...
// zua Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a zua
// Addresses message.
...
// NewMsgAddresses returns a new zua Addresses message that conforms to the
