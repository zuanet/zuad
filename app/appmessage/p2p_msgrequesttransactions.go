...
// MsgRequestTransactions implements the Message interface and represents a zua
...
// NewMsgRequestTransactions returns a new zua RequestTransactions message that conforms to
