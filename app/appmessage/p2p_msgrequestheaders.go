...
// MsgRequestHeaders implements the Message interface and represents a zua
...
// NewMsgRequstHeaders returns a new zua RequestHeaders message that conforms to the
