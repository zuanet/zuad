...
// MsgRequestRelayBlocks implements the Message interface and represents a zua
...
// NewMsgRequestRelayBlocks returns a new zua RequestRelayBlocks message that conforms to
