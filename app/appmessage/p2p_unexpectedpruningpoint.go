...
// MsgUnexpectedPruningPoint represents a zua UnexpectedPruningPoint message
...
// NewMsgUnexpectedPruningPoint returns a new zua UnexpectedPruningPoint message
