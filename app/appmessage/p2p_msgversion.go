...
var DefaultUserAgent = fmt.Sprintf("/zuad:%s/", version.Version())

// MsgVersion implements the Message interface and represents a zua version
...
// NewMsgVersion returns a new zua version message that conforms to the
