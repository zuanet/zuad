...
// MsgIBDChainBlockLocator implements the Message interface and represents a zua
...
// NewMsgIBDChainBlockLocator returns a new zua locator message that conforms to
