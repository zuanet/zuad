...
// RPCTransaction is a zuad transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a zuad transaction input representation
...
// RPCScriptPublicKey is a zuad ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a zuad transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a zuad outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a zuad utxo entry representation meant to be used
// over RPC
