...
import (
	...
	"github.com/zuanet/zuad/infrastructure/os/execenv"
	"github.com/zuanet/zuad/infrastructure/os/limits"
	"github.com/zuanet/zuad/infrastructure/os/signal"
	"github.com/zuanet/zuad/infrastructure/os/winservice"
...
var serviceDescription = &winservice.ServiceDescription{
	Name:        "zuadsvc",
	DisplayName: "Zuad Service",
	Description: "Downloads and stays synchronized with the Zua blockDAG and " +
...
// StartApp starts the zuad app, and blocks until it finishes running
func StartApp() error {
...
func (app *zuadApp) main(startedChan chan<- struct{}) error {
	...
	if err != nil {
		log.Errorf("Unable to start zuad: %+v", err)
		return err
	}

	defer func() {
		log.Infof("Gracefully shutting down zuad...")
		...
		log.Infof("Zuad shutdown complete")
	}()
