...
func (x *ZuadMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "ZuadMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *ZuadMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
