...
type GetBlockTemplateRequestMessage struct {
	...
	// Which zua address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether zuad thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when zuad is not synced.
	// That is because when zuad isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this zuad initiated the connection
	...
	// The timestamp of when this peer connected to this zuad
