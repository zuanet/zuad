...
func (x *ZuadMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "ZuadMessage_Addresses is nil")
	}
...
func (x *ZuadMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
