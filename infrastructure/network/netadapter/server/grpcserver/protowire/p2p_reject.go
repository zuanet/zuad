...
func (x *ZuadMessage_Reject) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "ZuadMessage_Reject is nil")
	}
...
func (x *ZuadMessage_Reject) fromAppMessage(msgReject *appmessage.MsgReject) error {
