...
func (x *ZuadMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "ZuadMessage_RequestPruningPointUTXOSet is nil")
	}
...
func (x *ZuadMessage_RequestPruningPointUTXOSet) fromAppMessage(
