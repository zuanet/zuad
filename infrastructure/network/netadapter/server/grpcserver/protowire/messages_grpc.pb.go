...
type P2P_MessageStreamClient interface {
	Send(*ZuadMessage) error
	Recv() (*ZuadMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *ZuadMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*ZuadMessage, error) {
	m := new(ZuadMessage)
...
func (x *p2PMessageStreamServer) Send(m *ZuadMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*ZuadMessage, error) {
	m := new(ZuadMessage)
...
func (x *rPCMessageStreamClient) Send(m *ZuadMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*ZuadMessage, error) {
	m := new(ZuadMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *ZuadMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*ZuadMessage, error) {
	m := new(ZuadMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
