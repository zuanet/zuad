/*
Package addressmanager implements concurrency safe Zua address manager.

# Address Manager Overview

In order maintain the peer-to-peer Zua network, there needs to be a source
of addresses to connect to as nodes come and go. The Zua protocol provides
