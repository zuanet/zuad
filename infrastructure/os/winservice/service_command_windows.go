...
// installService attempts to install the zuad service. Typically this should
...
// removeService attempts to uninstall the zuad service. Typically this should
...
// startService attempts to Start the zuad service.
