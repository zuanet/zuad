...
import (
	...
	"github.com/zuanet/zuad/domain/consensus/utils/virtual"
...
// This is a sanity test, to make sure that zuad doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
