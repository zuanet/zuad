...
Core (BFS) alzuaithms used during reindexing
...
// alzuaithm uses BFS for reaching all leaves and pushes
...
// reindexIntervalsEarlierThanRoot implements the reindex alzuaithm for the case where the
