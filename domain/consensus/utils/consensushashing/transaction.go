...
import (
	...
	"github.com/zuanet/zuad/domain/consensus/utils/serialization"
	...
	"github.com/zuanet/zuad/util/binaryserializer"
...
// writeTransactionInput encodes ti to the zua protocol encoding for a transaction
// input to w.
