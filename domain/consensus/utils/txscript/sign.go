...
// SignatureScript creates an input signature script for tx to spend ZUA sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend ZUA sent
