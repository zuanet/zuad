/*
Package txscript implements the zua transaction script language.

This package provides data structures and functions to parse and execute
zua transaction scripts.

# Script Overview

Zua transaction scripts are written in a stack-base, FORTH-like language.

The zua script language consists of a number of opcodes which fall into
several catezuaies such pushing and popping data to and from the stack,
...
Typical zua scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend zua.
