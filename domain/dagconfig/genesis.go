...
var genesisTxPayload = []byte{
	...
	0x01, // Varint
	0x00, // OP-FALSE
	0x42, 0x75, 0x67, 0x6e, 0x61, 0x20, 0x4d, 0x65,
	0x6d, 0x65, 0x20, 0x4e, 0x65, 0x74, 0x77, 0x6f,
	0x72, 0x6b,
}
...
var genesisHash = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0x00, 0x00, 0xa7, 0x85, 0x7b, 0xa8, 0x0d, 0x52, 0x16, 0xb9, 0xcc, 0x97, 0x2b, 0xe1, 0x86, 0x2d, 0x1c, 0x52, 0x52, 0xcd, 0x71, 0xc8, 0x9e, 0x9f, 0x49, 0x20, 0x7b, 0x69, 0x90, 0xb5, 0x91, 0x82,
})

var genesisMerkleRoot = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0x78, 0x24, 0x2c, 0x0d, 0x0e, 0x00, 0x7f, 0x3f, 0x2e, 0xc6, 0x76, 0x99, 0x88, 0x0f, 0xb7, 0x8d, 0x12, 0xcb, 0xbe, 0xc4, 0x34, 0xbd, 0x83, 0x9d, 0x5b, 0x5a, 0x1f, 0x93, 0xaa, 0x1a, 0xbb, 0x42,
})
...
var simnetGenesisTxPayload = []byte{
	...
	0x01, // Varint
	0x00, // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x73, 0x69, 0x6d, 0x6e, 0x65, 0x74,
}
...
var testnetGenesisTxPayload = []byte{
	...
	0x01, // Varint
	0x00, // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x74, 0x65, 0x73, 0x74, 0x6e, 0x65, 0x74,
}
