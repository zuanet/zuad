...
var genesisTxPayload = []byte{
	 0x8e, 0xc8, 0x98, 0x56, 0x8c, 0x68, 0x01, 0xd1, 0x3d, 0xf4, 0xee, 0x6e, 0x2a, 0x1b, 0x54, 0xb7, 0xe6, 0x23, 0x6f, 0x67, 0x1f, 0x20, 0x95, 0x4f, 0x05, 0x30, 0x64, 0x10, 0x51, 0x8e, 0xeb, 0x32,
}
...
var genesisHash = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0x87, 0xf0, 0xd7, 0xed, 0x84, 0x4d, 0x4a, 0x72, 0x5b, 0xb7, 0x2a, 0x0d, 0xd6, 0x75, 0x27, 0x78, 0xd3, 0xab, 0x1a, 0x0e, 0x84, 0x60, 0x42, 0xc4, 0x5e, 0xe2, 0x70, 0xad, 0x4b, 0x76, 0x2a, 0x12,
})
...
var genesisBlock = externalapi.DomainBlock{
	Header: blockheader.NewImmutableBlockHeader(
		...
		externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
			0x1A, 0x2A, 0x0E, 0x4C, 0x50, 0xA5, 0xE7, 0xC5, 0x4B, 0xC5, 0x7B, 0x2C, 0x6E, 0x3E, 0x55, 0x10, 0x9C, 0x0E, 0x2A, 0x36, 0xBE, 0x6E, 0x7C, 0x88, 0xA7, 0x72, 0xF6, 0x72, 0x85, 0x81, 0xDE, 0x3B,
		}),
		1637609671037,
		486722099,
		0x3392c,
...
var devnetGenesisTxPayload = []byte{
	...
	0x01,                                                                   // Varint
	0x00,                                                                   // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x64, 0x65, 0x76, 0x6e, 0x65, 0x74, // gor-devnet
}
...
var simnetGenesisTxPayload = []byte{
	...
	0x01,                                                                   // Varint
	0x00,                                                                   // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x73, 0x69, 0x6d, 0x6e, 0x65, 0x74, // gor-simnet
}
