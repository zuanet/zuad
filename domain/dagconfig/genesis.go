...
var devnetGenesisTxPayload = []byte{
	0x4f, 0x20, 0x53, 0xcb, 0x09, 0x4e, 0x6a, 0xaa,
	0x30, 0x30, 0x66, 0x23, 0x7b, 0x1d, 0x1b, 0xe3,
	0xec, 0xf3, 0xf6, 0xff, 0x08, 0xcb, 0x9d, 0xc7,
	0x1b, 0x7d, 0x46, 0x68, 0xc8, 0x0b, 0xb3, 0x0a,
}
...
var devnetGenesisHash = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0x4f, 0x20, 0x53, 0xcb, 0x09, 0x4e, 0x6a, 0xaa, 0x30,
	0x30, 0x66, 0x23, 0x7b, 0x1d, 0x1b, 0xe3, 0xec, 0xf3,
	0xf6, 0xff, 0x08, 0xcb, 0x9d, 0xc7, 0x1b, 0x7d, 0x46,
	0x68, 0xc8, 0x0b, 0xb3, 0x0a,
})

// devnetGenesisMerkleRoot is the hash of the first transaction in the genesis block
// for the devopment network.
var devnetGenesisMerkleRoot = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0xee, 0xc2, 0x6d, 0xdd, 0x9a, 0x40, 0x84, 0x49, 0xf8,
	0xe0, 0x6c, 0x62, 0x2c, 0x11, 0xd6, 0x1b, 0x94, 0x34,
	0x1b, 0x04, 0xfa, 0xe5, 0xea, 0xc8, 0xd7, 0x55, 0xc4,
	0x77, 0xb8, 0x29, 0x46, 0x24,
})
...
var testnetGenesisBlock = externalapi.DomainBlock{
	Header: blockheader.NewImmutableBlockHeader(
		...
		&externalapi.DomainHash{},
		externalapi.NewDomainHashFromByteArray(muhash.EmptyMuHashHash.AsArray()),
		0x655d66a0, // Updated timestamp for "01/05/2024"
		0x1e7fffff,
		0x14582,
		0,
		0,
