...
import (
	...
	consensusexternalapi "github.com/zuanet/zuad/domain/consensus/model/externalapi"
...
// selectTransactions implements a probabilistic transaction selection alzuaithm.
// The alzuaithm, roughly, is as follows:
