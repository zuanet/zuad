		...
		},
		{
			...
			paths: []testPath{
				...
				},
				{
					...
					extendedPrivateKey: "kprv665f9t2VPiP1h583WN4vGk8ypxyfHWNWgoroCPTXQWRmLZqWxdCUN8d7CdkuvM9DABa4HMcBTt9qZDaf61PZbYGgQc1ykQdsnMqy7fTCNrm",
				},
				{
					path:               "m/0'/1/2'/2",
...
func TestExtendedKey_DeriveFromPath(t *testing.T) {
	...
	master, err := NewMaster(seed, ZuaMainnetPrivate)
	if err != nil {
		t.Fatalf("GenerateSeed: %+v", err)
	}
