...
import (
	...
	"github.com/zuanet/zuad/cmd/zuawallet/libzuawallet/bip32"
...
func create(conf *createConfig) error {
	...
	fmt.Printf("Notice the above is neither a secret key to your wallet " +
		"(use \"zuawallet dump-unencrypted-data\" to see a secret seed phrase) " +
		"nor a wallet public address (use \"zuawallet new-address\" to create and see one)\n\n")
	...
	if len(signerExtendedPublicKeys) > 0 {
		cosignerIndex, err = libzuawallet.MinimumCosignerIndex(signerExtendedPublicKeys, extendedPublicKeys)
		if err != nil {
			return err
		}
	}
